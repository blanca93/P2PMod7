...
// Si autenticaciÃ³n falla o hay errores se ejecuta callback(error).
...
//                 .then( function(){
//                     // crea la sesiÃ³n para que el usuario acceda ya autenticado y redirige a /
